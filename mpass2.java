...
public class pass {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br1 = new BufferedReader(new FileReader("D:\\TCOB10\\MacroAssembler2\\src\\MNT.txt"));
        String line;
        ...
        br1 = new BufferedReader(new FileReader("D:\\TCOB10\\MacroAssembler2\\src\\argmnt.txt"));
        while ((line = br1.readLine()) != null) {
        ...
        br1 = new BufferedReader(new FileReader("D:\\TCOB10\\MacroAssembler2\\src\\MDT.txt"));
        while ((line = br1.readLine()) != null) {
            MDT[mdt_cnt] = new mdt();
        ...
        br1 = new BufferedReader(new FileReader("D:\\TCOB10\\MacroAssembler2\\src\\input4.txt"));
        BufferedWriter bw1 = new BufferedWriter(new FileWriter("D:\\TCOB10\\MacroAssembler2\\src\\output.txt"));
                    ...
                    if (MDT[macro_addr].stmnt.contains("mend") || MDT[macro_addr].stmnt.contains("MEND")) {
                        ...
                        for (String temp : temp_tokens) {
                            if (temp.matches("#[0-9]+")) {
                                ...
                                // Check if actual_parameter[num-1] is not null
                                if (actual_parameter[num - 1] != null) {
                                    bw1.write(actual_parameter[num - 1].argname + "\t");
                                } else {
                                    bw1.write("undefined_arg\t"); // Handle undefined argument case
                                }
                            } else {
                                bw1.write(temp + "\t");
                            }
