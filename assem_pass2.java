...
public class Pass2 {
	...
	public static void main(String[] args)throws IOException
	{
		...
		for(int i=0;i<total_symb;i++)
		{
			...
			System.out.println("Enter the Symbol Address");
		...
		for (int i=0;i<total_ltr;i++)
			System.out.println(literal_table[i].name+"\t"+literal_table[i].addr);
		
		BufferedReader br2=new BufferedReader(new FileReader("D:\\TCOB22\\Assembler\\Output.txt"));
		String line;
